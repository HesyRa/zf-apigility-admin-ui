...
angular.module("apigility-ui/api-module/api-module.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("apigility-ui/api-module/api-module.html",
    ...
    "            <select class=\"form-control\" ng-init=\"vm.module.visibility = (vm.module.visibility == 'undefined')? vm.module.visibility = options[0]: vm.module.visibility\" ng-model=\"vm.module.visibility\" ng-disabled=\"vm.disabled\">\n" +
